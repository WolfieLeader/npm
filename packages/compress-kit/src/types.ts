import type { CIPHER_ENCODING, ENCODING } from "@internal/helpers";
...
export interface DecompressOptions {
   ...
   * When set, decompression uses streaming mode and aborts early if the
   * cumulative byte count exceeds this limit — preventing memory exhaustion
   * from crafted payloads (decompression bombs).
   */
